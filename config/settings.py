...
# Signal Confidence Thresholds (increased to reduce signal volume)
MIN_CONFIDENCE_SWING = float(os.getenv("MIN_CONFIDENCE_SWING", "60"))
MIN_CONFIDENCE_SCALP = float(os.getenv("MIN_CONFIDENCE_SCALP", "75"))
